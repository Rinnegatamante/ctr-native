...
# Requires gcc-multilib, g++-multilib, and X11/GL/ALSA dev packages
...
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release "-DCMAKE_POLICY_VERSION_MINIMUM=3.5" -DCMAKE_C_FLAGS="-msse" -DCMAKE_CXX_FLAGS="-msse -fpermissive"
